...
export const RETROGRADES = [
  ...
  { planet: '土星', start: '2026-06-22', end: '2026-11-10', sign: '白羊', tip: '责任与自我定义的重构，适合"立边界/扛住压力"选题' },
  { planet: '木星', start: '2026-06-15', end: '2026-10-21', sign: '巨蟹', tip: '扩张能量内收，适合"回归家庭与安全感的疗愈"内容' },
...
export const ECLIPSES = [
  ...
  { date: '2026-08-12', type: '日全食', sign: '狮子', tip: '年度最强日食，自我表达与勇气的引爆点，适合"被看见"选题' },
...
export const YEAR_THEME = [
  { planet: '木星', sign: '巨蟹', desc: '疗愈、家庭、情绪安全感成为扩张主题，疗愈赛道整体被放大' },
